...
export class ItemDefinitionAfterEventSignal { private constructor(); subscribe(callback: (arg0: ItemDefinitionTriggeredAfterEvent)=>undefined): (arg0: ItemDefinitionTriggeredAfterEvent)=>undefined; unsubscribe(callback: (arg0: ItemDefinitionTriggeredAfterEvent)=>undefined): void}
export class ItemDefinitionBeforeEventSignal { private constructor(); subscribe(callback: (arg0: ItemDefinitionTriggeredBeforeEvent)=>undefined): (arg0: ItemDefinitionTriggeredBeforeEvent)=>undefined; unsubscribe(callback: (arg0: ItemDefinitionTriggeredBeforeEvent)=>undefined): void}
