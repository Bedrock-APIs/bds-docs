...
export enum EntityLifetimeState {Instantiated = "Instantiated", Loaded = "Loaded", Loading = "Loading", Removed = "Removed", Unloaded = "Unloaded"}
...
export enum ItemComponentTypes {Cooldown = "minecraft:cooldown", Durability = "minecraft:durability", Enchants = "minecraft:enchantments", Food = "minecraft:food"}
...
export class Block { private constructor(); readonly dimension: Dimension; readonly isAir: boolean; readonly isLiquid: boolean; readonly isSolid: boolean; isWaterlogged: boolean; readonly location: Vector3; readonly permutation: BlockPermutation; readonly 'type': BlockType; readonly typeId: string; readonly x: number; readonly y: number; readonly z: number; above(steps?: number): Block; below(steps?: number): Block; bottomCenter(): Vector3; canPlace(blockToPlace: BlockPermutation | BlockType | string, faceToPlaceOn?: Direction): boolean; center(): Vector3; east(steps?: number): Block; getComponent(componentId: string): BlockComponent; getItemStack(amount?: number, withData?: boolean): ItemStack; getRedstonePower(): number; getTags(): string[]; hasTag(tag: string): boolean; isValid(): boolean; north(steps?: number): Block; offset(offset: Vector3): Block; setPermutation(permutation: BlockPermutation): void; setType(blockType: BlockType | string): void; south(steps?: number): Block; trySetPermutation(permutation: BlockPermutation): boolean; west(steps?: number): Block}
...
//@ts-ignore allow class inheritance for native classes
export class BlockPistonComponent extends BlockComponent{ private constructor(); static readonly componentId: "minecraft:piston"; readonly isExpanded: boolean; readonly isExpanding: boolean; readonly isMoving: boolean; readonly isRetracted: boolean; readonly isRetracting: boolean; getAttachedBlocks(): Vector3[]}
//@ts-ignore allow class inheritance for native classes
...
export class ChatSendAfterEvent { private constructor(); message: string; sender: Player; sendToTargets: boolean; getTargets(): Player[]}
...
//@ts-ignore allow class inheritance for native classes
export class ChatSendBeforeEvent extends ChatSendAfterEvent{ private constructor(); cancel: boolean; setTargets(players: Player[]): void}
...
export class ContainerSlot { private constructor(); amount: number; readonly isStackable: boolean; keepOnDeath: boolean; lockMode: ItemLockMode; readonly maxAmount: number; nameTag?: string; readonly 'type': ItemType; readonly typeId?: string; getItem(): ItemStack; getLore(): string[]; getTags(): string[]; hasTag(tag: string): boolean; isStackableWith(itemStack: ItemStack): boolean; isValid(): boolean; setCanDestroy(blockIdentifiers?: string[]): void; setCanPlaceOn(blockIdentifiers?: string[]): void; setItem(itemStack?: ItemStack): void; setLore(loreList?: string[]): void}
...
export class EffectAddAfterEvent { private constructor(); effect: Effect; entity: Entity}
...
//@ts-ignore allow class inheritance for native classes
export class ItemDurabilityComponent extends ItemComponent{ private constructor(); static readonly componentId: "minecraft:durability"; damage: number; readonly maxDurability: number; getDamageChance(unbreaking: number): number; getDamageRange(): _00.NumberRange}
//@ts-ignore allow class inheritance for native classes
...
export class NavigationResult { private constructor(); readonly isFullPath: boolean; getPath(): Vector3[]}
//@ts-ignore allow class inheritance for native classes
...
//@ts-ignore allow class inheritance for native classes
export class PistonActivateBeforeEvent extends BlockEvent{ private constructor(); cancel: boolean; readonly isExpanding: boolean; readonly piston: BlockPistonComponent}
...
//@ts-ignore allow class inheritance for native classes
export class PlayerPlaceBlockBeforeEvent extends BlockEvent{ private constructor(); cancel: boolean; readonly face: Direction; readonly faceLocation: Vector3; itemStack: ItemStack; readonly player: Player}
